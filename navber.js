...
<div class="collapse navbar-collapse " id="main_nav">
    <ul class="navbar-nav ms-auto px-6 text-center">
                ...
                <div class="row">
                    <div class="col-4">
                        <ul class="mt-4 text-decoration-none fs-5 text-center">
                            <div class="hover-me">
                                <li class=" big-head" style="color: goldenrod; font-size: 16px;"><a href=""
        ...
        <li class="nav-item dropdown has-megamenu">
            <a class="nav-link  px-4 big-shot" href="#service">services</a>
            <div class="dropdown-menu megamenu" role="menu">
                <div class="row">
                    <div class="col-4">
                        <div class="dropdown">
                    ...
                    <div class="col-8  justify-content-center" style="background-color: #f7f8fd;">
                        ...
                        <p class="align-items-center">lorem Software Solutions specialize in developing </p>
                        <p> Employing structured approach right from wireframes prototypes and final design
                            <br>
                            <button class="btn btn-primary mt-2 text-center">get quote</button>
                        </p>
                    </div>
                </div>
            </div>
...
<div class="offcanvas-header border-0">
    <a href="index.html" id="navber-icons"><img src="download/Capture.PNG" style="color: goldenrod;"
            width="40px" height="30px" class="mb-2" alt="">
        Axess-Technology</a>
        ...
        <ul class="navbar-nav mx-auto px-6 text-center">
            <li class="nav-item dropdown has-megamenu">
                ...
                <div class="dropdown-menu megamenu p-0" role="menu">
                    <ul class="text-decoration-none fs-5 text-center p-4">
                        <li><a href="about.html">company profile</a></li>
                        <li><a href="">blog</a></li>
                        <li><a href="">partships</a></li>
                        <li><a href="">careers</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item dropdown has-megamenu">
                <a class="nav-link  px-4" href="#service">services</a>
                <div class="dropdown-menu megamenu p-0" role="menu">
                    <ul class="text-decoration-none fs-5 text-center p-4">
                        <li><a href="">Ui/ux Design</a></li>
                        <li><a href="webdevelopment.html">Web developemnt</a></li>
                        <li><a href="">software testing</a></li>
                        <li><a href="">Database Developer</a></li>
                        <li><a href="">cloud support</a></li>
                        <li><a href="">system admin</a></li>
                    </ul>
            </li>
            <li class="nav-item dropdown has-megamenu">
                <a class="nav-link  px-4" href="#industies">Industries</a>
            </li>
            <li class="nav-item dropdown has-megamenu">
                <a class="nav-link  px-4" href="#technology">careers</a>
            </li>
            <li class="nav-item dropdown has-megamenu">
                <a class="nav-link  px-4" href="contact.html">contact</a>
            </li>
